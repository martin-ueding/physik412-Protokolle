...
\begin{figure}
    \centering
    %\includegraphics[width=\textwidth]{../Abbildungen/Widerstand.pdf}
    \caption{%
...
\begin{figure}
    \centering
    %\includegraphics[width=\textwidth]{../Abbildungen/Hall-Effekt.pdf}
    \caption{%
...
\subsection{Nerst- und Righi-Leduc-Effekt}
