...
Der Ettings\-hausen-Effekt wirkt ähnlich wie der Hall-Effekt: Durch die
...
Der Nerst-Effekt ist eine Kombination des Seebeck-Effektes mit dem
Hall-Effekt. Liegt in einem Leiter ein Temperaturgradient senkrecht zu einem
angelegten magnetischen Feld vor, werden die durch den Seebeck-Effekt
fließenden Elektronen wie beim Hall-Effekt abgelenkt. Dabei entsteht ein
elektrisches Feld, bzw. ein senkrecht auf Gradient und Magnetfeld stehende
Strom. Dies ist scheinbar eine Umkehrung des Ettings\-hausen-Effektes.

Der Nerst- und der Et\-tings\-hausen-Effekt werden häufig auch als erster bzw.
zweiter Et\-tings\-hausen-Nerst-Effekt bezeichnet.
...
Bei Probe \probeB{} sind die Werte \SI{<< hf_301_hall_R_H_plus
>>}{\meter\squared\per\coulomb} und \SI{<< hf_301_hall_R_H_minus
>>}{\meter\squared\per\coulomb} für $R_{\text H+, \text S}$ bzw\@. $R_{\text
H-, \text S}$
...
Wir bilden Mittelwert und Fehler und erhalten so für $R_{\text H}$ die Werte
\SI{<< hf_540_hall_R_H >>}{\meter\squared\per\coulomb} bzw\@. \SI{<<
