...
Fermi-Verteilung, die diese Anregungsverteilung beschreibt, gezeigt.
...
\begin{table}[htbp]
    ...
    \begin{tabular}{SS|SS}
        {$V_{\text H+} / \si\volt$} &
        {$V_{\text H-} / \si\volt$} &
        {$R_{\text H+, \text S} / \si{\volt\per\tesla\per\ampere}$} &
        {$R_{\text H-, \text S} / \si{\volt\per\tesla\per\ampere}$} \\
        \midrule
...
>>}{\volt\per\tesla\per\ampere}$ und $R_{\text H-, \text S} = \SI{<<
    hf_540_hall_R_H_minus >>}{\volt\per\tesla\per\ampere}$ aus allen fünf
    Messreihen.

Bei Probe \probeB{} sind die Werte $R_{\text H+, \text S} = \SI{<<
hf_301_hall_R_H_plus >>}{\volt\per\tesla\per\ampere}$ und $R_{\text H-, \text
S} = \SI{<< hf_301_hall_R_H_minus >>}{\volt\per\tesla\per\ampere}$.
...
\begin{table}[htbp]
    \centering
    \begin{tabular}{SS|S}
        {$R_{\text{H}1, \text{S}} / \si{\volt\per\tesla\per\ampere}$} &
        {$R_{\text{H}2, \text{S}} / \si{\volt\per\tesla\per\ampere}$} &
        {$R_{\text{H}, \text{S}} / \si{\volt\per\tesla\per\ampere}$} \\
        \midrule
...
hf_540_hall_R_H >>}{\volt\per\tesla\per\ampere}$ und $R_{\text H} = \SI{<<
