...
\begin{figure}[htbp]
    ...
    \caption{%
        ...
        Datenpunkte \num{<< rot_lower >>} bis \num{<< rot_upper >>}
        (Arrayindex). Der Mittelwert des Hauptmaximums liegt bei \SI{<<
        rot_primary_center >>}{\degree} und hat eine Halbwertsbreite von \SI{<<
            rot_primary_fwhm >>}{\degree}. Das Nebenmaximum liegt bei \SI{<<
