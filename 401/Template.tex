...
\subsection{Qualitative Beobachtung der Aufspaltung}
...
registrieren. An die Messdaten passen wir ein Polynom dritter Ordnung,
\[
    B(I) = a + bI + cI^2 + dI^3,
\]
an. Als Parameter erhalten wir durch die Anpassung:
\begin{align*}
...
\subsection{Messung der Aufspaltung}
