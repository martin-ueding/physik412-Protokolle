...
Brechungsindizes
\begin{align*}
    \Delta s &= 2dn\sec\del{\beta} -
    2dn_\text{Luft}\tan\del{\beta}\sin\del{\alpha}\\
    &= 2d\sec\del{\beta}
    \del{n -\underbrace{n_\text{Luft}\sin\del{\alpha}}_
    {=n\sin\del{\beta}}\sin\del{\beta}}\\
    &=2nd\sec\del{\beta}\del{1-\sin^2\del{\beta}} \\
    &=2nd\cos\del{\beta}.
    \intertext{Diese soll nun ein Vielfaches der Wellenlänge sein:}
    m\lambda &= 2nd\cos\del\beta
    \intertext{%
