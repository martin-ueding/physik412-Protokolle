...
\emph{TC}, \emph{Gain} und \emph{Blanking} am Receiver auf \num{0.01}, 75\%
und \emph{On}, \emph{Ref Out} und \emph{CW Out} des Synthesizers auf \emph{On}
und \emph{Off} und \emph{MG}, \emph{Sync}, \emph{Pulse A} und \emph{Pulse B} am
Pulse Programmer auf \emph{Off}, \emph{A}, \emph{On} und \emph{Off} gestellt.
