...
\[
    M = M_0 - \del{M_0-M_\text{Offset}}\exp\del{ -\frac{\tau}{T_1} }
\]

da wir nicht von einer Anfangsmagnetisierung von \num{0} ausgehen.
Wir erhalten daraus
...
\[
    M_0-2\del{M_0-M_\text{Offset}}\exp\del{-\frac{\tau}{T_1}}
\]
