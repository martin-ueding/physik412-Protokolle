...
die $y$-Werte gemittelt, die Standardabweichung als Fehler genommen.

Da hier nur die lokalen Maxima interessant sind, haben wir mit der Python
Funktion \texttt{scipy.signal.find\_peaks\_cwt} diese Maxima finden lassen.
Die Funktion führt zuerst eine Faltung mit einer Ricker
Welle\footnote{Siehe \cite{wikipedia/Mexican_hat_wavelet}.}.
