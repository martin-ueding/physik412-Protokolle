...
und mit der Erwartung, dass die Maxima $\tau$ auseinander sind, die Skala
...
eine Skala von \num{<< MG_skala >>} Sekunden pro Pixel und eine
Relaxationszeit von:
\[
    {T_2}_\text{MG} = \SI{<< MG_T >>}{\second}
\]
