...
\texttt{open}, \texttt{TC}, \texttt{Gain} und \texttt{Blanking} am Receiver
auf \num{0.01}, 75\% und \texttt{On}, \texttt{Ref Out} und \texttt{CW Out}
des Synthesizers auf \texttt{On} und \texttt{Off} und \texttt{MG},
\texttt{Sync}, \texttt{Pulse A} und \texttt{Pulse B} am Pulse Programmer auf
\texttt{Off}, \texttt{A}, \texttt{On} und \texttt{Off} gestellt.
